    ...
    <div className="max-w-2xl mx-auto text-center">
      ...
      <div className="bg-gray-50 rounded-lg p-6 mb-8">
        ...
        <div className="text-sm text-gray-600 space-y-2">
          <p><strong>Tenant ID:</strong> {signupResult.tenant_id}</p>
          <p><strong>Plan:</strong> Basic (Free Trial)</p>
      ...
      <div className="space-y-4">
        <button
          ...
          className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-4 px-6 rounded-lg font-medium hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 shadow-lg hover:shadow-xl"
        >
        ...
        <div className="flex space-x-4">
          <Link
            href="/help"
            className="flex-1 bg-white text-gray-700 py-3 px-4 border border-gray-300 rounded-lg font-medium hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
          >
