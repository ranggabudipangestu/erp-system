...
import { ChangePasswordRequest, PasswordValidation } from '@/types/auth';
...
export default function ChangePasswordForm({ onSubmit, isLoading, onCancel }: ChangePasswordFormProps) {
  ...
  const validateForm = (): boolean => {
    ...
    if (!newPassword) {
      ...
      newErrors.newPassword = 'New password does not meet security requirements';
    }
            ...
            {newPassword && (
              <div className="mt-3 space-y-2">
                ...
                <div className="grid grid-cols-2 gap-1">
                  ...
                  <div className={`flex items-center text-xs ${passwordValidation.special ? 'text-green-600' : 'text-gray-400'} col-span-2`}>
                    <svg className="h-3 w-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-yellow-700">
                <strong>Security Notice:</strong> After changing your password, you'll be signed out of all devices for security.
              </p>
            </div>
          </div>
        </div>
